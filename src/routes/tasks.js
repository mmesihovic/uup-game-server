...
const validateTurnInBody = (data) => {
    if(!!data) {
        ...
        return keys.includes('passed_tests') && keys.includes('total_tests') && (typeof data['passed_tests'] == 'number') && (typeof data['total_tests'] == 'number') && data['passed_tests'] <= data['total_tests'];
    }
    return false;
}
